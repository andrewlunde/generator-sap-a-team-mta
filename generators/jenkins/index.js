...
function get_landscape_api(so_far) { 
  ...
  var retstr = "https://api.cf." + so_far.deploy_landscape + ".hana.ondemand.com";
...
module.exports = class extends Generator {
    ...
    this.answers = await this.prompt([
      ...
      },
     {
      ...
      },
      {
        type: "input",
        name: "deploy_params",
        message: "Confirm the deploy parameters(-e for merging with an mtaext).",
  ...
  writing() {
    ...
    this.fs.copyTpl(this.templatePath('Jenkinsfile'),this.destinationPath('Jenkinsfile'),subs);

    this.fs.copyTpl(this.templatePath('.pipeline/config.yml'),this.destinationPath('.pipeline/config.yml'),subs);
